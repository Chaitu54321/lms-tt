package com.yourname.library.dto;
...
public class RegisterRequest {
    ...
    public static class RegisterRequestBuilder {
        ...
        public String toString() {
            return "RegisterRequest.RegisterRequestBuilder(firstname=" + this.firstname + ", lastname=" + this.lastname + ", username=" + this.username + ", email=" + this.email + ", password=" + this.password + ")";
        }
    }
}
